...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CAVIAR', // 您的昵称 例如 tangly1024
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '1332526693@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  WIDGET_PET_LINK:
    ...
    'https://imuncle.github.io/live2d/model/tororo/tororo.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
